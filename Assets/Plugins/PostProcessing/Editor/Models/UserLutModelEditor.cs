		...
		public override void OnInspectorGUI()
		{
			...
			if(lut != null)
			{
				...
				if(importer != null) // Fails when using an internal texture
				{
					...
					var valid = (importer.anisoLevel == 0) && (importer.mipmapEnabled == false) && (importer.sRGBTexture == false) && (importer.textureCompression == TextureImporterCompression.Uncompressed);
#else
