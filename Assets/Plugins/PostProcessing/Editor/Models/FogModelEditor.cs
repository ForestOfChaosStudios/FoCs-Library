...
namespace UnityEditor.PostProcessing
{
	...
	public class FogModelEditor: PostProcessingModelEditor
	{
		...
		{
			EditorGUILayout.HelpBox("This effect adds fog compatibility to the deferred rendering path; enabling it with the forward rendering path won't have any effect. Actual fog settings should be set in the Lighting panel.",
			                        MessageType.Info);
