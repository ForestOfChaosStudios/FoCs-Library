...
namespace UnityEditor.PostProcessing
{
	public class PostProcessingModelEditor
	{
		...
		protected SerializedProperty FindSetting<T, TValue>(SerializedProperty          prop, Expression<Func<T, TValue>> expr) => prop.FindPropertyRelative(ReflectionUtils.GetFieldPath(expr));
	}
}
