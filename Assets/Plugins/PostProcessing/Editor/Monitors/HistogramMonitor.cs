...
namespace UnityEditor.PostProcessing
{
	public class HistogramMonitor: PostProcessingMonitor
	{
		...
		public override void OnMonitorSettings()
		{
			...
			mode          = (PostProcessingProfile.MonitorSettings.HistogramMode)EditorGUILayout.EnumPopup(mode, FxStyles.preDropdown, GUILayout.MaxWidth(100f));
		...
		public override void OnMonitorGUI(Rect r)
		{
			if(Event.current.type == EventType.Repaint)
			{
				...
				// Sizing
				var width  = m_HistogramTexture != null? Mathf.Min(m_HistogramTexture.width,  r.width  - 65f) : r.width;
				var height = m_HistogramTexture != null? Mathf.Min(m_HistogramTexture.height, r.height - 45f) : r.height;
