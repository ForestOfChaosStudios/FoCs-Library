...
namespace UnityEditor.PostProcessing
{
	...
	internal sealed class TrackballGroupDrawer: PropertyDrawer
	{
		...
		private static readonly Dictionary<string, MethodInfo> m_TrackballMethods = new Dictionary<string, MethodInfo>();
		...
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label) => m_Size + (4f * 2f) + (EditorGUIUtility.singleLineHeight * 3f);
	}
}
