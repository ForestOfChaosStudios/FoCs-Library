...
namespace UnityEngine.PostProcessing
{
	...
	public sealed class AmbientOcclusionComponent: PostProcessingComponentCommandBuffer<AmbientOcclusionModel>
	{
		...
		public override bool active               => model.enabled && (model.settings.intensity > 0f)                          && !context.interrupted;
		...
		public override CameraEvent GetCameraEvent() => ambientOnlySupported && !context.profile.debugViews.IsModeActive(DebugMode.AmbientOcclusion)? CameraEvent.BeforeReflections : CameraEvent.BeforeImageEffectsOpaque;
