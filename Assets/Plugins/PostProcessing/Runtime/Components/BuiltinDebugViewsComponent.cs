...
namespace UnityEngine.PostProcessing
{
	public sealed class BuiltinDebugViewsComponent: PostProcessingComponentCommandBuffer<BuiltinDebugViewsModel>
	{
		...
		public override CameraEvent GetCameraEvent() => model.settings.mode == BuiltinDebugViewsModel.Mode.MotionVectors? CameraEvent.BeforeImageEffects : CameraEvent.BeforeImageEffectsOpaque;
		...
		private class ArrowArray
		{
			...
			{
				// Base shape
				var arrow = new Vector3[6] {new Vector3(0f, 0f, 0f), new Vector3(0f, 1f, 0f), new Vector3(0f, 1f, 0f), new Vector3(-1f, 1f, 0f), new Vector3(0f, 1f, 0f), new Vector3(1f, 1f, 0f)};
