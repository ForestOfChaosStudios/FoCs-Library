...
namespace UnityEngine.PostProcessing
{
	...
	public class ScreenSpaceReflectionModel: PostProcessingModel
	{
		...
		public struct ReflectionSettings
		{
			...
			[Tooltip("Blurriness of reflections.")] [Range(0.1f, 8.0f)] public float reflectionBlur;
		...
		public struct Settings
		{
			...
			public static Settings defaultSettings =>
					new Settings
					{
							...
							intensity      = new IntensitySettings {reflectionMultiplier = 1f, fadeDistance = 100f, fresnelFade = 1f, fresnelFadePower = 1f},
