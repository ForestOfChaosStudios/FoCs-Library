	...
	public class ColorGradingModel: PostProcessingModel
	{
		...
		public struct TonemappingSettings
		{
			...
			public static TonemappingSettings defaultSettings =>
					new TonemappingSettings {tonemapper = Tonemapper.Neutral, neutralBlackIn = 0.02f, neutralWhiteIn = 10f, neutralBlackOut = 0f, neutralWhiteOut = 10f, neutralWhiteLevel = 5.3f, neutralWhiteClip = 10f};
		}
		...
		public struct BasicSettings
		{
			...
			public static BasicSettings defaultSettings => new BasicSettings {postExposure = 0f, temperature = 0f, tint = 0f, hueShift = 0f, saturation = 1f, contrast = 1f};
		}
		...
		public struct ChannelMixerSettings
		{
			...
			public static            ChannelMixerSettings defaultSettings => new ChannelMixerSettings {red = new Vector3(1f, 0f, 0f), green = new Vector3(0f, 1f, 0f), blue = new Vector3(0f, 0f, 1f), currentEditingChannel = 0};
		}
		...
		public struct LogWheelsSettings
		{
			...
			public static                        LogWheelsSettings defaultSettings => new LogWheelsSettings {slope = Color.clear, power = Color.clear, offset = Color.clear};
		}
		...
		public struct LinearWheelsSettings
		{
			...
			public static                       LinearWheelsSettings defaultSettings => new LinearWheelsSettings {lift = Color.clear, gamma = Color.clear, gain = Color.clear};
		}
		...
		public struct ColorWheelsSettings
		{
			...
			public static           ColorWheelsSettings  defaultSettings => new ColorWheelsSettings {mode = ColorWheelMode.Log, log = LogWheelsSettings.defaultSettings, linear = LinearWheelsSettings.defaultSettings};
		}
