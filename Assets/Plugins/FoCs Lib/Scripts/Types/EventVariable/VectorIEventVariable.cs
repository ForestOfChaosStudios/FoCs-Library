...
namespace ForestOfChaosLib.Types.EventVariable
{
	...
	{
		public Vector2IEventVariable()
			: this(Vector2I.Zero)
		{ }

		public Vector2IEventVariable(Vector2I data)
			: base(data)
		{ }
	...
	{
		public Vector3IEventVariable()
			: this(Vector3I.Zero)
		{ }

		public Vector3IEventVariable(Vector3I data)
			: base(data)
		{ }
	...
	{
		public Vector4IEventVariable()
			: this(Vector4I.Zero)
		{ }

		public Vector4IEventVariable(Vector4I data)
			: base(data)
		{ }
