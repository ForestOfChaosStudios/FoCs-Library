...
namespace ForestOfChaosLib.AdvVar.Editor
{
	...
	public class AdvReferencePropertyDrawerBase: ObjectReferenceDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			{
				UseConstant.boolValue = FoCsGUI.DrawPropertyWithMenu(position.SetHeight(SingleLinePlusPadding), UseConstant.boolValue? ConstantValue : Variable, label, OPTIONS_ARRAY, UseConstant.boolValue? 0 : 1).Value == 0;
