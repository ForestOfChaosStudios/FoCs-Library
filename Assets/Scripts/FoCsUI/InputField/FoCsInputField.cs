...
namespace ForestOfChaosLib.FoCsUI.InputField
{
	public abstract class FoCsInputField: FoCsBehavior
	{
		...
		protected void ValueChange(string arg0) { OnValueChange.Trigger(arg0); }
		protected void EndEdit(string     arg0) { OnEndEdit.Trigger(arg0); }
		protected void Submit(string      arg0) { OnSubmit.Trigger(arg0); }
		protected void Deselect(string    arg0) { OnDeselect.Trigger(arg0); }
