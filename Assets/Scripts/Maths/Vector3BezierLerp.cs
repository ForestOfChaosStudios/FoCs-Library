...
{
	public static class Vector3BezierLerp
	{
		...
		public static Vector3 Lerp(BezierCurveV3DQuad curveV3D, float time)
		{
			return Lerp(curveV3D.CurvePositions.ToArray(), time);
		}

		public static Vector3 Lerp(BezierCurveV3DCube curveV3D, float time)
		{
			return Lerp(curveV3D.CurvePositions.ToArray(), time);
		}
		...
		public static Vector3 Lerp(ICurveV3D curveV3D, float time)
		{
			return Lerp(curveV3D.CurvePositions.ToArray(), time);
		}

		public static Vector3 Lerp(List<Vector3> curve, float time)
		{
